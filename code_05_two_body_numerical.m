...
tspan = [0, 3] * 3600; % [s] % this is OFT-Example-02 on slides 22
%
% tspan = [0, 1.132] * 3600; % [s] % this leads to ~120 deg. OFT-Example-01 on slides 14
% tspan = [0, 4077.04]; % [s] % this leads to ~120 deg. OFT-Example-01 on slides 14
